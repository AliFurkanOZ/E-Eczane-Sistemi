        ...
        <>
            ...
            <div className="hidden md:flex md:w-64 md:flex-col md:fixed md:inset-y-0">
                <div className="flex flex-col flex-grow sidebar-official overflow-y-auto">
                    <div className="flex items-center px-4 py-4 border-b border-gray-200 bg-[#7c3aed]">
                        <div className="bg-white rounded p-1.5">
                            <Shield className="h-6 w-6 text-[#7c3aed]" />
                        </div>
                        <div className="ml-3">
                            <h1 className="text-sm font-bold text-white">E-Eczane</h1>
                            <p className="text-xs text-purple-100">Yönetim Paneli</p>
                        </div>
                    </div>
                        ...
                        {navigation.map((item) => {
                            ...
                            return (
                                <Link
                                    ...
                                    style={isActive ? { borderLeftColor: '#7c3aed', color: '#7c3aed', background: '#f3e8ff' } : {}}
                                >
                        ...
                        {navigation.map((item) => {
                            ...
                            return (
                                <Link
                                    key={item.name}
                                    to={item.href}
                                    className={`flex flex-col items-center px-4 py-2 min-w-[70px] ${isActive ? 'text-[#7c3aed]' : 'text-gray-500'}`}
                                >
